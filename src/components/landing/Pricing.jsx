...
export default function Pricing() {
  ...
  const tiers = [
    getTierData("free", {
      ...
      popular: false,
      features: Array.isArray(t("pricing.freeFeatures")) ? t("pricing.freeFeatures") : [],
      notIncluded: Array.isArray(t("pricing.freeNotIncluded")) ? t("pricing.freeNotIncluded") : [],
    ...
    getTierData("monthly", {
      ...
      popular: true,
      features: Array.isArray(t("pricing.premiumFeatures")) ? t("pricing.premiumFeatures") : [],
      notIncluded: [],
    ...
    getTierData("quarterly", {
      ...
      popular: false,
      features: Array.isArray(t("pricing.quartFeatures")) ? t("pricing.quartFeatures") : [],
      notIncluded: [],
    ...
    getTierData("custom", {
      ...
      popular: false,
      features: Array.isArray(t("pricing.customFeatures")) ? t("pricing.customFeatures") : [],
      notIncluded: [],
